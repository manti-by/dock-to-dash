...
UUID = dock-to-dash@manti.by.gmail.com
...
INSTALLNAME = dock-to-dash@manti.by.gmail.com
...
./schemas/gschemas.compiled: ./schemas/org.gnome.shell.extensions.dock-to-dash.gschema.xml
	glib-compile-schemas ./schemas/

potfile: ./po/docktodash.pot

mergepo: potfile
	for l in $(MSGSRC); do \
		msgmerge -U $$l ./po/docktodash.pot; \
	done;

./po/docktodash.pot: $(TOLOCALIZE) Settings.ui
	mkdir -p po
	xgettext -k --keyword=__ --keyword=N__ --add-comments='Translators:' -o po/docktodash.pot --package-name "Dash to Dock" --from-code=utf-8 $(TOLOCALIZE)
	intltool-extract --type=gettext/glade Settings.ui
	xgettext -k --keyword=_ --keyword=N_ --join-existing -o po/docktodash.pot Settings.ui.h
...
_build: all
	...
	for l in $(MSGSRC:.po=.mo) ; do \
		...
		cp $$l $$lf/LC_MESSAGES/docktodash.mo; \
	done;
