...
class MonitorsConfig {
  ...
  _updateMonitorsIndexes() {
    ...
    for (const monitor of this._monitors) {
      ...
      // always has index 0, so let's follow what dock-to-dash does in docking.js
...
var Settings = GObject.registerClass({
  ...
  _init() {
    ...
    if (Me)
      this._settings = ExtensionUtils.getSettings('org.gnome.shell.extensions.dock-to-dash');
    else
      this._settings = new Gio.Settings({schema_id: 'org.gnome.shell.extensions.dock-to-dash'});
